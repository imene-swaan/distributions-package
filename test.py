...
class TestGaussianClass(unittest.TestCase):
    ...
    def test_meancalculation(self):
        self.assertEqual(self.gaussian.calculate_mean(), 78.0909090909091 , 'calculated mean not as expected')

    def test_stdevcalculation(self):
        self.assertEqual(round(self.gaussian.calculate_stdev(True), 2), 92.87, 'sample standard deviation incorrect')
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.binomial.read_file('numbers_binomial.txt')
    ...
    def test_pdf(self):
        self.assertEqual(round(self.binomial.density(5), 5), 0.07465)
        self.assertEqual(round(self.binomial.density(3), 5), 0.01235)

        self.binomial.replace_stats_with_data()
        self.assertEqual(round(self.binomial.density(5), 5), 0.05439)
        self.assertEqual(round(self.binomial.density(3), 5), 0.00472)
